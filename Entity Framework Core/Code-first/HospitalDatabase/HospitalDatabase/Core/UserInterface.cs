namespace P01_HospitalDatabase.Core
{
    ...
    internal class UserInterface
    {
        ...
        public void AddPatient(HospitalContext context)
        {
            ...
            Console.WriteLine("Write patient firstname:");
            string patientFirstname = Console.ReadLine();

            Console.WriteLine("Write patient lastname:");
        ...
        {
            Console.WriteLine("Write patient firstname and lastname:");
        ...
        public void EditPatient(HospitalContext context)
        {
            ...
            Console.WriteLine("Please, write patient firstname and lastname you want to edit:");
            List<string> names = Console.ReadLine()
                .Split(" ")
                .ToList();
            ...
            if (context.Patients.Any(p => p == patientToEdit))
            {
                ...
                else if (answer == "Remove medicament")
                {
                    ...
                    var patientMedicament = context.PatientMedicaments.FirstOrDefault(p => p.Patient == patientToEdit
                      && p.Medicament == medicament);
