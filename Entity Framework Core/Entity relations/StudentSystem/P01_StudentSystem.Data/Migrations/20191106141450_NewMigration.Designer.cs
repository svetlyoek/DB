...
namespace P01_StudentSystem.Data.Migrations
{
    ...
    [Migration("20191106141450_NewMigration")]
            ...
            modelBuilder.Entity("P01_StudentSystem.Data.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Algorithms",
                            Price = 200m,
                            StartDate = new DateTime(2019, 11, 6, 14, 14, 50, 189, DateTimeKind.Utc).AddTicks(84)
                        },
                        new
                        {
                            CourseId = 2,
                            ...
                            Name = "Algorithms",
                            Price = 200m,
                            StartDate = new DateTime(2019, 11, 6, 14, 14, 50, 189, DateTimeKind.Utc).AddTicks(2866)
                        });
                });
            ...
            modelBuilder.Entity("P01_StudentSystem.Data.Models.Homework", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CourseId = 1,
                            StudentId = 1,
                            SubmissionTime = new DateTime(2019, 11, 6, 14, 14, 50, 204, DateTimeKind.Utc).AddTicks(1825)
                        },
                        new
                        {
                            HomeworkId = 2,
                            ...
                            CourseId = 2,
                            StudentId = 2,
                            SubmissionTime = new DateTime(2019, 11, 6, 14, 14, 50, 204, DateTimeKind.Utc).AddTicks(3893)
                        });
                });
            ...
            modelBuilder.Entity("P01_StudentSystem.Data.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisteredOn = new DateTime(2019, 11, 6, 14, 14, 50, 194, DateTimeKind.Utc).AddTicks(3957)
                        },
                        new
                        {
                            StudentId = 2,
                            ...
                            Name = "Pesho",
                            PhoneNumber = "0888565656",
                            RegisteredOn = new DateTime(2019, 11, 6, 14, 14, 50, 194, DateTimeKind.Utc).AddTicks(5333)
                        });
                });
